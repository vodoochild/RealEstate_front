...
export default class Nav extends React.Component {
    render() {
        return (<div>/*<nav className="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
            <div className="container">
                ...
                <a className="navbar-brand text-brand" href="index.html">Estate<span
                    className="color-b">Agency</span></a>
            ...
            <div className="container">
                ...
                <div className="navbar-collapse collapse justify-content-center" id="navbarDefault">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link active" href="property-grid.html">Property</a>
                        </li>
                        <li className="nav-item">
