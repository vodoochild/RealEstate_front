...
import {FormGroup, Collapse, Input, Col, NavbarBrand, Nav, NavItem, NavLink, Label, Row,InputGroup,Jumbotron, Container } from 'reactstrap';
                ...
                {({values}) =>(
                 <Form className={styles.SearchDataForm} >
                    <div className={styles.DataFormInputs}>
                        ...
                        <Col sm={14}>
                        <Input tag={Field} type="text" name="search" id="search_input" placeholder="Région, département, ville..." required />
                        </Col>
                        <Col sm={14}>
